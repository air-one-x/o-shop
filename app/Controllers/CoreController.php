...
class CoreController {
    ...
    public function __construct(){
        ...
        $authorizeRoles = $acl[$currentRoute];
      
        $this->checkAuthorization($authorizeRoles);
    }
    /**
    ...
    public function checkAuthorization($tableau){
        if(!isset($_SESSION['USER'])){
            echo 'Veuillez vous connecter';
            exit;
        }
        
        if(!in_array($_SESSION['USER']->getRole(),$tableau)){
            echo 'vous n\'avez pas las autorisations requises.';
             exit;
        }
    }

    public function checkConnexionUser(){
        if(isset($_SESSION['USER'])){
